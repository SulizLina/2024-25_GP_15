...
<Header active={from === 'motorcycle' ? 'motorcycleslist' : 'driverslist'} />
    ...
    <path d="M2.5 2L22.5 22" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" /> </svg> Violation ID</h3>
            <p style={{fontSize:'18px', marginLeft:'45px'}}>{violation.violationID}</p>
            <h3 style={{color:"#059855", fontWeight:'bold',fontSize:'20px' }}> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="35" height="35" style={{marginBottom:'-10px', marginRight:'10px'}} color="#059855" fill="none">
    ...
    <path d="M15 12L13 12" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            ...
            <p style={{fontSize:'18px', marginLeft:'45px'}}>{violation.streetMaxSpeed} km/h</p>
            <h3 style={{color:"#059855", fontWeight:'bold',fontSize:'20px' }}> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="35" height="35" style={{marginBottom:'-10px', marginRight:'10px'}} color="#059855" fill="none">
...
</svg>Motorcycle Speed</h3>
            <p style={{fontSize:'18px', marginLeft:'45px'}}>{violation.driverSpeed} km/h</p>
            <h3 style={{color:"#059855", fontWeight:'bold',fontSize:'20px' }}> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="35" height="35" style={{marginBottom:'-10px', marginRight:'10px'}} color="#059855" fill="none">
  ...
  According to the General Department of Traffic regulations, This speed violation is considered reckless and marks the driver's <strong> {getOrdinal(violation.count30 > 0 ? violation.count30 : violation.count50)}</strong> offense. <br/> As a result, the penalty amount has been increased.
    ...
    <path d="M12 7.99982V11.9998L14 13.9998" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            ...
            <p style={{fontSize:'18px', marginLeft:'45px'}}>{new Date(violation.time * 1000).toLocaleTimeString()}</p>
            <h3 style={{color:"#059855", fontWeight:'bold',fontSize:'20px' }}> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="35" height="35" style={{marginBottom:'-10px', marginRight:'10px'}} color="#059855" fill="none">
    ...
    <path d="M3 8H21" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            ...
            <p style={{fontSize:'18px', marginLeft:'45px'}}>{new Date(violation.time * 1000).toLocaleDateString('en-US')}</p>
            <h3 style={{color:"#059855", fontWeight:'bold',fontSize:'20px' }}> <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="35" height="35" style={{marginBottom:'-10px', marginRight:'10px'}} color="#059855" fill="none">
    ...
    <path d="M10 14L4 20" stroke="currentColor" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round" />
            ...
            <p style={{fontSize:'18px', marginLeft:'45px'}}>{violation.location}</p>
            <div className="map">
              {violation.position && 
